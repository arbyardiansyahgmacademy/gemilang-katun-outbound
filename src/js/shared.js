...
export function renderNavbar(activePage = 'home') {
  ...
  navContainer.innerHTML = `
    <header class="sticky top-0 z-50 bg-[#1A080C]/95 backdrop-blur-md border-b border-[#451823] shadow-lg">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16 sm:h-20">
          ...
          <a href="/" class="flex items-center space-x-3 group">
            <img 
              ...
              class="w-10 h-10 object-contain rounded-full border border-[#451823] shadow-sm group-hover:scale-105 transition-all duration-300" 
              onerror="this.onerror=null; this.src='/src/assets/images/logo.webp';"
            />
            <div>
              <span class="text-lg sm:text-xl font-bold tracking-tight text-[#E6C280]">GemilangKatun<span class="text-white">Outbond</span></span>
              <p class="text-[9px] text-[#C0A8AE] font-medium tracking-widest uppercase">Provider No.1 Batu & Malang</p>
            </div>
          </a>

          <!-- Desktop Navigation on Right -->
          <nav class="hidden md:flex items-center space-x-2 lg:space-x-5">
            ${navLinksHtml}
          </nav>

          <!-- Mobile Hamburger Toggle -->
          <div class="md:hidden flex items-center">
            <button id="mobile-menu-btn" aria-label="Menu Switcher" class="p-2 rounded-lg text-[#C0A8AE] hover:text-white hover:bg-[#280E15] transition-colors focus:outline-none">
        ...
        <div id="mobile-menu" class="hidden md:hidden pb-6 pt-2 border-t border-[#451823] space-y-2">
          ${links.map(link => `
            <a href="${link.href}" class="block px-4 py-2.5 rounded-lg text-sm font-medium transition-all ${activePage === link.key ? 'bg-[#8C2333]/30 text-[#E6C280] font-bold' : 'text-[#C0A8AE] hover:bg-[#280E15] hover:text-white'}">
              ${link.name}
            </a>
          `).join('')}
          <div class="pt-2 px-4">
            <a href="https://wa.me/6282211221909?text=Halo%20GemilangKatunOutbond,%20saya%20ingin%20tanya%20paket" target="_blank" class="w-full py-3 rounded-full bg-[#8C2333] border border-[#E6C280]/40 text-white text-center block text-xs font-bold uppercase tracking-wider shadow-md">
...
export function renderFooter() {
  ...
  footerContainer.innerHTML = `
    <footer class="bg-[#140508] border-t border-[#451823] pt-12 sm:pt-16 pb-10 text-[#C0A8AE]">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="pb-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div class="lg:col-span-4 space-y-4">
            <a href="/" class="inline-flex items-center space-x-3 group">
              ...
              />
              <div>
                <span class="text-lg font-bold tracking-tight text-[#E6C280]">GemilangKatun<span class="text-white">Outbond</span></span>
                <p class="text-[9px] text-[#C0A8AE] font-semibold tracking-widest uppercase">Provider No.1 Batu & Malang</p>
              </div>
            </a>

            <p class="text-xs text-[#C0A8AE] leading-relaxed font-light">
            ...
            <div class="pt-2">
              <span class="text-[11px] uppercase font-bold tracking-wider text-[#E6C280] block mb-2">Ikuti Media Sosial Kami</span>
              <div class="flex items-center space-x-2.5">
                <!-- Instagram -->
                <a href="https://instagram.com" target="_blank" rel="noopener" aria-label="Instagram GemilangKatunOutbond" class="w-9 h-9 rounded-full bg-[#280E15] border border-[#451823] text-[#E6C280] hover:bg-[#8C2333] hover:text-white hover:border-[#E6C280] flex items-center justify-center transition-all duration-300 shadow-sm hover:-translate-y-0.5">
                ...
                <!-- YouTube -->
                <a href="https://youtube.com" target="_blank" rel="noopener" aria-label="YouTube GemilangKatunOutbond" class="w-9 h-9 rounded-full bg-[#280E15] border border-[#451823] text-[#E6C280] hover:bg-[#8C2333] hover:text-white hover:border-[#E6C280] flex items-center justify-center transition-all duration-300 shadow-sm hover:-translate-y-0.5">
                  <svg class="w-4 h-4 fill-current" viewBox="0 0 24 24">
          ...
          <div class="lg:col-span-2 space-y-3">
            <h4 class="text-xs font-bold text-[#E6C280] uppercase tracking-widest flex items-center space-x-2">
              <span class="w-1.5 h-1.5 rounded-full bg-[#E6C280]"></span>
              <span>Navigasi</span>
            </h4>
          ...
          <div class="lg:col-span-3 space-y-3">
            ...
            <ul class="space-y-3 text-xs">
              <li class="flex items-start space-x-2.5">
                <div class="w-6 h-6 rounded-md bg-[#8C2333]/30 border border-[#E6C280]/20 text-[#E6C280] flex items-center justify-center shrink-0 mt-0.5">
                  <svg class="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                  </svg>
                </div>
                <span class="text-[#C0A8AE] leading-relaxed">Jl. Raya Coban Rondo No. 88, Pandesari, Kec. Pujon, Kab. Malang, Jawa Timur 65391</span>
              </li>
              <li class="flex items-center space-x-2.5">
                <div class="w-6 h-6 rounded-md bg-[#8C2333]/30 border border-[#E6C280]/20 text-[#E6C280] flex items-center justify-center shrink-0">
                  <svg class="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                </div>
                <a href="mailto:admin@gemilangkatunoutbond.co.id" class="text-[#C0A8AE] hover:text-[#E6C280] transition-colors truncate">admin@gemilangkatunoutbond.co.id</a>
              </li>
              <li class="flex items-center space-x-2.5">
                <div class="w-6 h-6 rounded-md bg-[#8C2333]/30 border border-[#E6C280]/20 text-[#E6C280] flex items-center justify-center shrink-0">
                  <svg class="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <a href="https://wa.me/6282211221909" target="_blank" class="text-[#E6C280] font-bold hover:underline">+62 822-1122-1909 (WA)</a>
              </li>
            </ul>
          </div>
        ...
        <div class="border-t border-[#451823] pt-8 flex flex-col md:flex-row items-center justify-between text-[11px] text-[#C0A8AE] space-y-3 md:space-y-0">
          ...
          <div class="flex items-center space-x-6 text-[11px]">
            ...
            <a href="/contact.html" class="hover:text-[#E6C280] hover:underline">Lokasi Google Maps</a>
          </div>
        </div>
...
export function renderFloatingWA() {
  ...
  if (!waElement) {
    ...
    waElement.style.cssText = 'position: fixed; bottom: 24px; right: 24px; z-index: 9999; display: flex; align-items: center; pointer-events: auto; opacity: 0; visibility: hidden; transition: opacity 0.4s ease, visibility 0.4s ease;';
    waElement.className = 'group cursor-pointer';
    waElement.innerHTML = `
      <!-- Tooltip label -->
      <div class="hidden sm:flex items-center space-x-2 bg-[#280E15] text-white text-xs px-3.5 py-2 rounded-full border border-[#451823] shadow-2xl font-bold tracking-wide transition-all group-hover:scale-105 mr-3">
        <span class="w-2.5 h-2.5 rounded-full bg-[#25D366] animate-ping"></span>
        <span>Chat Admin WA</span>
        <span class="text-[#E6C280] font-bold text-[10px] bg-[#8C2333]/40 px-2 py-0.5 rounded-full border border-[#E6C280]/20">24/7</span>
      </div>
  ...
  if (!bttElement) {
    ...
    bttElement.style.cssText = 'position: fixed; bottom: 92px; right: 28px; z-index: 9999; pointer-events: auto; opacity: 0; visibility: hidden; transition: opacity 0.4s ease, visibility 0.4s ease;';
    bttElement.className = 'w-11 h-11 bg-[#8C2333] hover:bg-[#A32A3E] text-white rounded-full flex items-center justify-center shadow-xl border border-[#E6C280]/40 transform hover:scale-110 active:scale-95 group';
  ...
  // Scroll threshold logic: tampilkan setelah scroll 2x viewport height
  ...
  // Initial check (seharusnya masih tersembunyi saat load)
  handleScrollVisibility();
}
...
export function openBookingModal(packageData = {}) {
  ...
  if (!modal) {
    ...
    modal.className = 'fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-md p-4 hidden';
    modal.innerHTML = `
      <div class="bg-[#280E15] border border-[#451823] rounded-3xl max-w-lg w-full p-6 sm:p-8 text-white relative shadow-2xl">
        <button id="close-modal-btn" class="absolute top-5 right-5 text-[#C0A8AE] hover:text-white p-1 transition-colors">
          <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/></svg>
        </button>

        <div class="flex items-center space-x-3 mb-6">
          <div class="p-2.5 bg-[#8C2333]/30 text-[#E6C280] rounded-xl border border-[#E6C280]/30">
          ...
          <div>
            ...
            <p class="text-xs text-[#C0A8AE]">Pesan langsung & dapatkan harga promo rombongan!</p>
          </div>
        </div>
        ...
        <form id="booking-modal-form" class="space-y-4">
          ...
          <div>
            <label class="block text-xs font-semibold text-[#C0A8AE] mb-1">Paket Yang Dipilih</label>
            <input type="text" id="modal-package-name" readonly class="w-full bg-[#1A080C] border border-[#451823] rounded-xl px-3.5 py-2.5 text-sm text-[#E6C280] font-bold focus:outline-none">
          </div>

          <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
              <label class="block text-xs font-semibold text-[#C0A8AE] mb-1">Nama Pemesan / Instansi</label>
              <input type="text" id="modal-user-name" required placeholder="Contoh: Budi (PT Sentosa)" class="w-full bg-[#1A080C] border border-[#451823] rounded-xl px-3.5 py-2.5 text-sm text-white placeholder-[#8C6B73] focus:border-[#E6C280] focus:outline-none">
            </div>
            <div>
              <label class="block text-xs font-semibold text-[#C0A8AE] mb-1">No. WhatsApp</label>
              <input type="tel" id="modal-user-phone" required placeholder="082211221909" class="w-full bg-[#1A080C] border border-[#451823] rounded-xl px-3.5 py-2.5 text-sm text-white placeholder-[#8C6B73] focus:border-[#E6C280] focus:outline-none">
            </div>
          </div>

          <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
              <label class="block text-xs font-semibold text-[#C0A8AE] mb-1">Estimasi Peserta</label>
              <input type="number" id="modal-participants" min="10" value="30" class="w-full bg-[#1A080C] border border-[#451823] rounded-xl px-3.5 py-2.5 text-sm text-white focus:border-[#E6C280] focus:outline-none">
            </div>
            <div>
              <label class="block text-xs font-semibold text-[#C0A8AE] mb-1">Rencana Tanggal Acara</label>
              <input type="date" id="modal-event-date" class="w-full bg-[#1A080C] border border-[#451823] rounded-xl px-3.5 py-2.5 text-sm text-white focus:border-[#E6C280] focus:outline-none">
            </div>
          </div>

          <div>
            <label class="block text-xs font-semibold text-[#C0A8AE] mb-1">Catatan Khusus / Permintaan Tambahan</label>
            <textarea id="modal-notes" rows="2" placeholder="Contoh: Perlu opsi catering vegetarian, spanduk custom, dll." class="w-full bg-[#1A080C] border border-[#451823] rounded-xl px-3.5 py-2.5 text-sm text-white placeholder-[#8C6B73] focus:border-[#E6C280] focus:outline-none"></textarea>
          </div>

          <div id="booking-modal-alert" class="hidden text-xs p-3 rounded-xl bg-[#8C2333]/30 text-[#E6C280] border border-[#E6C280]/30"></div>

          <button type="submit" class="w-full py-3.5 rounded-full bg-[#8C2333] hover:bg-[#A32A3E] text-white border border-[#E6C280]/40 font-bold uppercase tracking-wider text-xs flex items-center justify-center space-x-2 transition-all shadow-lg">
...
export function setupLightboxGallery(itemsArray = []) {
  ...
  if (!modal) {
    ...
    modal.innerHTML = `
      ...
      <div id="lightbox-card-wrapper" class="relative bg-[#280E15] rounded-2xl sm:rounded-3xl shadow-2xl overflow-hidden max-w-4xl w-full border border-[#451823] flex flex-col md:flex-row m-auto max-h-[90vh] sm:max-h-[85vh] transition-all animate-modal-pop">
        
        <!-- X Close Button (Prominent & Always Visible) -->
        <button id="close-lightbox-btn" aria-label="Tutup Galeri" class="absolute top-3 right-3 z-30 w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-black/60 hover:bg-[#8C2333] text-white flex items-center justify-center shadow-xl transition-all transform hover:scale-110 focus:outline-none border border-[#E6C280]/30">
          <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M6 18L18 6M6 6l12 12"/></svg>
        </button>

        <!-- Left / Top: Image View area with Prev/Next buttons -->
        <div class="relative md:w-3/5 bg-[#1A080C] flex items-center justify-center min-h-[220px] md:min-h-[360px] max-h-[48vh] md:max-h-none overflow-hidden group p-2">
          <img id="lightbox-img" src="" alt="Foto Galeri" class="w-full h-full object-contain max-h-[42vh] md:max-h-[70vh] rounded-lg" />
          
          <!-- Prev button -->
          <button id="prev-lightbox-btn" aria-label="Foto Sebelumnya" class="absolute left-2 sm:left-3 z-20 w-9 h-9 sm:w-11 sm:h-11 rounded-full bg-black/60 hover:bg-[#8C2333] text-white flex items-center justify-center border border-white/20 shadow-xl transition-all transform hover:scale-110 active:scale-95 focus:outline-none">
          ...
          <!-- Next button -->
          <button id="next-lightbox-btn" aria-label="Foto Selanjutnya" class="absolute right-2 sm:right-3 z-20 w-9 h-9 sm:w-11 sm:h-11 rounded-full bg-black/60 hover:bg-[#8C2333] text-white flex items-center justify-center border border-white/20 shadow-xl transition-all transform hover:scale-110 active:scale-95 focus:outline-none">
        ...
        <div class="md:w-2/5 p-4 sm:p-6 flex flex-col justify-between bg-[#280E15] text-white space-y-3 overflow-y-auto max-h-[44vh] md:max-h-none">
          <div class="space-y-2">
            <span id="lightbox-category" class="inline-block px-3 py-0.5 rounded-full bg-[#8C2333]/30 text-[#E6C280] text-[11px] font-bold uppercase tracking-wider border border-[#E6C280]/30">
              Coban Rondo
            </span>
            ...
            <p id="lightbox-desc" class="text-xs sm:text-sm text-[#C0A8AE] leading-relaxed font-light">
          ...
          <div class="pt-3 border-t border-[#451823] space-y-2">
            <a id="lightbox-wa-btn" href="https://wa.me/6282211221909" target="_blank" class="w-full py-2.5 rounded-full bg-[#8C2333] hover:bg-[#A32A3E] text-white text-xs font-bold uppercase tracking-wider text-center flex items-center justify-center space-x-2 shadow-md transition-all border border-[#E6C280]/30">
              <span>Tanya Paket Ini via WA</span>
              <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"/></svg>
            </a>
            
            <p class="text-[10px] text-[#C0A8AE] text-center italic">
